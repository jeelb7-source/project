...
<div id="loading-area"></div>
    ...
    <div class="page-content bg-white">
        <!-- inner page banner -->
        <div class="dlab-bnr-inr overlay-primary  bg-pt" style="background-image:url(wallpaper/shopbanner.webp);">
            <div class="container">
			...
			<div class="section-full bg-white content-inner">
				<div class="container">
					<div class="section-head text-black text-center">
						...
						<p>Professional care with a personal touch — because your nails deserve the best.</p>
					</div>
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6 m-b30">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 m-b30">
							<div class="service-box text-center">
								...
								<div class="service-content">
									<h6 class="text-uppercase text-primary">Vrushti Patel</h6>
