					...
					<div class="dlab-topbar-left">
						<div class="widget widget_getintuch">
                            <ul class="d-flex align-items-center">
                                <li><i class="ti-location-pin"></i><strong>Our Location</strong>145 N Los Ave, NY</li>
                                <li><i class="ti-mobile"></i><strong>Phone Number</strong>145 N Los Ave, NY</li>
                            </ul>
                        </div>
					</div>
				</div>
            ...
            <div class="main-bar bg-primary clearfix ">
                <div class="container clearfix style-1">
                    ...
                    <div class="logo-header mostion">
						<a href="index.html" class="dez-page"><img src="images/logo-white1.png" alt=""></a>
					</div>
                    <!-- nav toggle button -->
					...
					<div class="dz-nav-button">
						<a href="booking.html" class="site-button style-1 radius-no">Book Now</a>
					</div>
                </div>
            </div>
        </div>
