...
<div id="loading-area"></div>
                       ...
                       <ul class="nav navbar-nav">	
							...
							<li><a href="javascript:void(0);">Pages <i class="fa fa-chevron-down"></i></a>
								<ul class="sub-menu">
									...
									<li><a href="images/overlay/rrdiagonal-line.png.html" class="dez-page">Error 404</a></li>
    ...
    <div class="page-content bg-white">
        <!-- inner page banner -->
        <div class="dlab-bnr-inr dlab-bnr-inr overlay-primary bg-pt" style="background-image:url(images/banner/bnr2.jpg);">
            <div class="container">
				...
				<div class="container">
					...
					<div class="site-filters style1 clearfix center">
						<ul class="filters" data-toggle="buttons">
							<li data-filter="" class="btn active"><input type="radio"><a href="portfolio-grid-4.html#"><span>All</span></a></li>
							<li data-filter="web" class="btn"><input type="radio"><a href="portfolio-grid-4.html#"><span>Haircuts</span></a></li>
							<li data-filter="advertising" class="btn"><input type="radio"><a href="portfolio-grid-4.html#"><span>Coloring</span></a></li>
							<li data-filter="branding" class="btn"><input type="radio"><a href="portfolio-grid-4.html#"><span>Makeup</span></a></li>
							<li data-filter="design" class="btn"><input type="radio"><a href="portfolio-grid-4.html#"><span>Massage</span></a></li>
							<li data-filter="photography" class="btn"><input type="radio"><a href="portfolio-grid-4.html#"><span>Highlights</span></a></li>
						</ul>
					</div>
					<div class="clearfix">
